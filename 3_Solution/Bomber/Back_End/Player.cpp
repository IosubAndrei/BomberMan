...
Player::Player(int ID,sf::Vector2f startingPosition, ePlayerControllerType controllerType):
	m_maxBombCount(5), m_currentBombCount(1), m_bombsPlaced(0),m_ID(ID),m_previousPosition(),
	m_position(startingPosition),m_newPosition(startingPosition),m_controllerType(controllerType),
